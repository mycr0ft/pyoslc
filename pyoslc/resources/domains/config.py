...
class ConfigurationResource(BaseResource):
    ...
    def __init__(self, about=None, types=None, properties=None, description=None, identifier=None, short_title=None,
        ...
        super().__init__(
            about, types, properties, description, identifier, short_title,
        ...
        self.__was_derived_from = was_derived_from if was_derived_from is not None else ''
        self.__was_revision_of = was_revision_of if was_revision_of is not None else ''
        self.__was_generated_by = was_generated_by if was_generated_by is not None else ''
...
class Configuration(ConfigurationResource):
    ...
    def __init__(self, about=None, types=None, properties=None, description=None, identifier=None, short_title=None,
        ...
        self.__contains_relation = contains_relation if contains_relation is not None else set()
        self.__contained_by_relation = contained_by_relation if contained_by_relation is not None else set()
